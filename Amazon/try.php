...
<html lang="en">
    <head>
        ...
        <title>Buy Campus Mens Rodeo Pro BLK/T.BLU Running Shoe - 9 UK (CG-237) at Amazon.in</title>
    ...
    <body>
        <header class="header">
            <div class="container ">
                ...
                <div class="login-container border-white">
                    ...
                    <div class="container ">
                        <div class="dropdown">
                            <button class="dropbtn"><span class="icon">Hello,sign in<p id="account">Account & Lists</p>
                                </span></button>
                            <div class="dropdown-content">
                                <input type="submit" value="Sign in" id="continue" onclick="location.href='login.html'">
                                <p id="new">New customer? <a href="account.html" class="link">Start here.</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <img src="/Images/stars2.png" alt="" id="img2">
        ...
        <img src="/Images/campus_shoes" alt="" id="img1">
        ...
        <div id="box2">
            <p id="p6"><sup style="font-size: 15px;">₹</sup>649<sup style="font-size: 15px;">00</sup></p>
            ...
            <div id="p7">
                ...
                <p id="p8">In stock</p>
                <p style="margin: 0 0 0 20px; display: inline-block;">Sold by </p><p class="link" style="display: inline-block; margin: 7px 0 0 0;"> Camusactivewear</p> and<p class="link" style="display: inline-block; margin: 0 0 0 20px;"> Fulfilled by Amazon</p>
                ...
                <input type="submit" value="Buy Now" id="buy" onclick="location.href='buy.html'" >
            </div>
        </div>
