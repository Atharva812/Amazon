    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function performSearch() {
                ...
                if (searchTerm !== '') {
                    // Simulate search results (replace with actual data fetching)
                    const results = [
                        { name: 'Controller', link: 'Product.php' },
                        { name: 'Shoe', link: 'Product2.php' },
                        { name: 'Item 3', link: 'page3.php' },
                        { name: 'Item 4', link: 'page4.php' }
                    ];

                    // Open a new page for each search result
            ...
            <div class="container ">
                ...
                <div class="address-container border-white" onclick="redirectToAddressPage()">
                   <div class="icon-address">
                      ...
                      <p id="address"><span><p style="cursor: pointer;">Deliver to <?php echo $name; ?><br><?php echo $city; ?>&nbsp <?php echo $pincode; ?></p>
                      <p></p>
                   </div>
                </div>
